# Development Log
## Nov. 21st
#### OpenFlights dataset cleaning and filtering: Airports data
...
#### OpenFlights dataset cleaning and filtering: Airports_data
 - Created "airport-data" folder  
The "airport-data" folder will store any data related to airports dataset or generated from *openflights_airport_data_filter.py*.  
...
#### OpenFlights dataset cleaning and filtering: Airlines_data
 - Created "airline-data" folder  
The "airline-data" folder will store any data related to airlines dataset or generated from *openflights_airline_data_filter.py*.  
...
#### OpenFlights dataset cleaning and filtering: Routes_data
 - Created "route-data" folder  
The "route-data" folder will store any data related to routes dataset or generated from *openflights_route_data_filter.py*.  
